...
import { FileText, ArrowLeft, Coins, Sun, Moon } from 'lucide-react';
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="space-y-8 text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>
              For queries regarding these Terms: <span className="text-indigo-600 dark:text-indigo-400">legal@capitaltrust.app</span>
            </p>
          </section>
