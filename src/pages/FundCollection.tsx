  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-fade-in text-slate-900 mt-16 sm:mt-20 mb-5 px-3 sm:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {/* Left Column: History of Past Collections */}
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  {history.map((h) => (
                    <tr key={h.id} className="hover:bg-slate-50/30 transition">
        ...
        {/* Right Column: Collection Editor / Form */}
        <div className="lg:col-span-7 bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col">
          <div className="p-4 border-b border-slate-100 bg-slate-50/40 flex justify-between items-center">
            ...
            {editingGroupId && (
              <button
                type="button"
                onClick={handleInitNewCollection}
                className="px-2.5 py-1.5 bg-slate-950 hover:bg-slate-900 text-white rounded-lg text-[9px] font-bold uppercase tracking-wider transition flex items-center gap-1 cursor-pointer shadow"
              >
          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-4">
                ...
                <table className="w-full text-left text-xs border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-100 text-slate-700 bg-white">
                    {filteredMembers.map((member) => (
                      <tr key={member.userId} className="hover:bg-slate-50/20 transition">
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-3">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-2.5 bg-slate-950 hover:bg-slate-900 active:scale-[0.98] text-white rounded-lg text-xs font-bold uppercase tracking-wider transition-all disabled:opacity-50 flex items-center justify-center gap-1.5 cursor-pointer shadow-md shadow-slate-950/15"
              >
                {submitting ? (
