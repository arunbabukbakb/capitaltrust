...
export default function LoanEntry() {
  ...
  const estimatedInterest = (amountNum * effectiveRate * tenureNum) / 1200;
  const estimatedTotal = amountNum + estimatedInterest;
  const estimatedInstallment = tenureNum ? estimatedTotal / tenureNum : 0;
    ...
    <div className="space-y-4 sm:space-y-8 animate-fade-in text-slate-900 mt-16 sm:mt-20 mb-5 px-3 sm:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8">
        <form onSubmit={handleSubmit} className="lg:col-span-8 bg-white rounded-xl p-4 sm:p-6 border border-slate-200 shadow-sm space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              {loanType === 'Group' && (
                <button
                  ...
                  className="px-2 py-1.5 sm:px-3 sm:py-2 bg-slate-950 text-white rounded-md sm:rounded-lg text-[10px] sm:text-xs font-bold flex items-center gap-1 disabled:opacity-40 cursor-pointer"
                >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="w-full flex-1 bg-slate-950 text-white hover:bg-slate-900 font-bold py-2.5 sm:py-3.5 rounded-md sm:rounded-lg text-[10px] sm:text-xs uppercase tracking-wider shadow active:scale-[0.99] transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer"
            >
        ...
        <aside className="lg:col-span-4 space-y-4 sm:space-y-6">
          <div className="bg-slate-950 text-white rounded-xl p-4 sm:p-6 border border-slate-900 shadow-xl space-y-4">
