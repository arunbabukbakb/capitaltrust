...
import { Shield, Layers, User, LogOut, Menu, X, Coins, LayoutDashboard, Building2, Mail, Send, Wrench, Activity, Video, Tags } from 'lucide-react';
...
export default function SuperAdminLayout() {
  ...
  const navItems = [
    ...
    { label: 'Organization Types', path: '/admin/organization-types', icon: Tags },
